...
**batch size / review 分離 / adversarial checks（CONTRIBUTING.md §9 — 基準・項目は §9 を参照、ここでは複製しない）**
- [ ] batch size は §9 の基準の範囲内、または超過理由と review 単位を本 PR 本文に明記した
- [ ] §9 の review separation 方針（該当する場合、author とは別の reviewer による確認）を実施した
- [ ] 該当する §9 の adversarial checks を確認した
